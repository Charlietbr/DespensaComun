...
* seeds      
    * Archivos CSV de los que parte el seed para definir manualmente groups, products y users. El resto de colecciones (conversations, favorites, messages y transactions) se rellenan automáticamente.
    * seed_csv.js. Toma los contenidos definidos de forma manual y ejecuta el seed completo.
...
| Categoría      | Método | Ruta                              | Autenticación | FUNCIÓN                 |
|----------------|--------|-----------------------------------|---------------|-------------------------|
| CONVERSACIONES |        |                                   |               |                         |
...
|                | post   |  "/:id/approve/:userId"           | Auth SÍ       | approveJoinRequest      |
|                | delete |  "/:id/reject/:userId"            | AutH SÍ       | rejectJoinRequest       |
